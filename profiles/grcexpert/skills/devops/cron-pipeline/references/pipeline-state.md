...
> Last refreshed: 2026-06-03 from `cronjob(action='list')`.
...
| 08:00 Fridays | `3d249b60776d` | Content Pipeline — Friday Review | obsidian, obsidian-markdown, profile-routing | local | file, terminal, skills, browser | ok |

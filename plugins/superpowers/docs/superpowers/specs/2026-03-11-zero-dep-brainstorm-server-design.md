...
- [[20 - Intermediaries/Intermediaries MOC|Intermediaries]] — billing/timesheet/contract terms pass through the intermediary layer.
- [[05 - AI/00 - AI-MOC/AI-MOC|AI Operations]] — AI/prompt/agent material belongs to the AI operations map.
- [[10 - Customers/Customers MOC|Customers]] — delivery/customer terms need customer operating context.

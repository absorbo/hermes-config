...
Verification complete. All 5 repairable links are now resolved. Let me compile the final audit report.

## GraphWeaver MOC Integrity Audit — Complete
...
| Metric | Count |
|--------|-------|
| MOCs/Overviews checked | 32 |
| Total wikilinks scanned | 392 |
| Links resolved OK | 369 |
| Skipped (in code spans) | 11 |
...
### Repairs Applied (5)
**File:** `04 - Knowledge/Knowledge MOC.md`
- Added missing `shared/` folder prefix to 5 reference wikilinks:
  - `70 - Writing/01_Input/references/Cold War 1945-1991` → `70 - Writing/01_Input/shared/references/Cold War 1945-1991`
  - `70 - Writing/01_Input/references/The Berlin Wall A World Divided, 1961-1989` → `70 - Writing/01_Input/shared/references/The Berlin Wall A World Divided, 1961-1989`
  - `70 - Writing/01_Input/references/Spy Wars Moles, Mysteries, and Deadly Games` → `70 - Writing/01_Input/shared/references/Spy Wars Moles, Mysteries, and Deadly Games`
  - `70 - Writing/01_Input/references/Encyclopedia of Cold War Espionage, Spies, and Secret Operations` → `70 - Writing/01_Input/shared/references/Encyclopedia of Cold War Espionage, Spies, and Secret Operations`
  - (one duplicate link on line 105 also fixed)

---

### Remaining Broken Links (12) — Not Repairable

| File | Broken Target | Reason |
|------|---------------|--------|
| `10 - Customers/Delvaux/00-Overview.md` | `KE-002-ISO27001` | Target note does not exist anywhere in vault |
| `11 - Entities/Eldenwyck-Co/00-Overview.md` | `11-Entities/Eldenwyck-Co/Task-Ensure-Payment` | Target does not exist (hyphen-path variant; no file at spaced path either) |
| `11 - Entities/Minotaur-Solutions/00-Overview.md` | `11-Entities/Minotaur-Solutions/Task-Accounting-Scan` | Target does not exist |
| `11 - Entities/Minotaur-Solutions/00-Overview.md` | `11-Entities/Minotaur-Solutions/Task-KMOP-Registration` | Target does not exist |
| `11 - Entities/Oxford-Holdings/00-Overview.md` | `11-Entities/Oxford-Holdings/Task-Accounting-Cleanup` | Target does not exist |
| `11 - Entities/TruSecure/00-Overview.md` | `11-Entities/TruSecure/Project-Go-To-Market` | Target does not exist (×3 occurrences) |
| `11 - Entities/TruSecure/00-Overview.md` | `11-Entities/TruSecure/Task-Follow-Up` | Target does not exist |
| `11 - Entities/TruSecure/00-Overview.md` | `11-Entities/TruSecure/Customer-Personas` | Target does not exist (×2 occurrences) |
| `Clawbot Vault MOC.md` | `70 - Writing/03_Output/vienna-protocol/chapters/` | Target is a folder path, not a note file |

**Note:** The 11 entity/customer dead links reference task/project notes that were never created. The 1 folder link in `Clawbot Vault MOC.md` points to a directory containing chapter files but no index note. No speculative edits were made.

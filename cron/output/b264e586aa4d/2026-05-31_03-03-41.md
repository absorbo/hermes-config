...
## GraphWeaver MOC Integrity Audit — Clawbot Vault — 2026-05-31

| Metric | Value |
|--------|-------|
| MOC/Overview files checked | 32 |
| Total wikilinks audited | 386 |
| Broken links found | 26 |
| Repaired | 13 |
| Remaining (dead targets) | 13 |

### Repairs Applied

**Clawbot Vault MOC → Obsidian Vault MOC** (13 fixes): All MOC backlinks referenced a non-existent file name `Clawbot Vault MOC`. The actual vault root MOC is `Obsidian Vault MOC.md`. Patched in all 13 affected files.

### Remaining Dead Links (unrepairable — target files do not exist)

| File | Links | Issue |
|------|-------|-------|
| `11 - Entities/*/00-Overview.md` (5 files) | 10 | Hyphen-path `11-Entities/...` — files absent even at corrected `11 - Entities/...` path |
| `70 - Writing/Writing Studio MOC.md` | 1 | `appendix-a-historical-verification-log` — file moved/deleted (only draft outline remains in `02_WIP/drafts/`) |
| `Obsidian Vault MOC.md` | 1 | Links to directory `chapters/`, not a file — wikilinks cannot resolve directories |
| `10 - Customers/Delvaux/00-Overview.md` | 1 | `KE-002-ISO27001` — note never created |

**No speculative edits made. No files deleted. No templates or archives modified.**

...
**ALL profiles share the same 4-tier failover system:**
...
4. **Fallback 3:** fatman:11434 / qwen3.6:35b-a3b-coding-bf16 (local, always available)

All profiles use `api_max_retries: 2` for resilience. Each fallback tier gets up to 2 attempts before the chain moves to the next tier. See `references/model-failover-testing.md` for diagnostic procedures.
...
## ✅ Content Pipeline Orchestration Complete

### Summary

**This Week's Theme:** Case-style scenarios or lessons (Bucket 7)
- LinkedIn angle: A real-world case — company with all compliance certificates failed under actual regulator scrutiny
- Facebook angle: Commercial adaptation — "They checked every box. Then the auditor asked one question they couldn't answer."

### Drafts Created

| ID | Channel | Title | Status |
|----|---------|-------|--------|
| W3-LI-A | LinkedIn | They Passed the Checklist, Failed the Moment | Ready for approval |
| W3-FB-A | Facebook | They Checked Every Box, Then the Auditor Asked One Question | Ready for approval |

### LinkedIn Post (W3-LI-A)
*Opening hook:* "You can pass a compliance audit and still be completely exposed. That bothers me more than a failed penetration test ever could."

- 6 paragraphs, teach-first narrative
- Tells story of company with ISO 27001 + SOC 2 Type II that failed when regulator asked for real evidence
- Teaches lesson: compliance = snapshot, operational control = stress test
- Ends with call to action: "Stop chasing checkboxes. Build something that still stands when someone actually kicks the tires."
- Hashtags: #Cybersecurity #Compliance #RiskManagement #InfoSec

### Facebook Post (W3-FB-A)
*Opening hook:* "You can pass every compliance audit and still be blind to what is happening inside your company."

- 5 shorter paragraphs, more conversational
- Same narrative foundation, more commercial lean
- Positions TruSecure gap review
- Soft CTA: "If you want to know what your compliance score really tells you — send me a message."
- Hashtags: #Cybersecurity #BusinessProtection #Compliance #RiskManagement

### Files Updated
1. ✅ `60 - Content-Pipeline/Drafts.md` — Added Week 3 section with both drafts
2. ✅ `01 - Daily Notes/2026-05-26.md` — Added "Content Drafts Ready for Review" section

...
**Timesheet pre-fill complete — 2026-05-26 (Tuesday, Week 22)**

| Metric | Value |
|--------|-------|
| **Files changed** | 1 (`2026-05-26.md`) |
| **Files created** | 0 |
| **Customers logged** | 2 |
| **Total hours** | 1.25h |
| **Confirmed hours** | 0 (no EOD feedback) |
| **`[ESTIMATE]` tags** | 2 |
| **`[CONFIRM]` flags** | 1 |

**Entries added:**
- **Delvaux** — 0.25h `[ESTIMATE]` — Daily standup + JIRA update (Tuesday standup-day pattern; Medium confidence)
- **Verlinfo/Verla** — 1.0h `[ESTIMATE]` — Voorbereiding Gesprek Gwijde NIS2 meeting `[CONFIRM: did meeting occur and what was actual duration?]` (Medium confidence)

**Skipped / not logged:**
- Content pipeline drafts (W3-LI-A, W3-FB-A) — auto-generated by Hermes, no manual work detected
- Internal admin tasks (Zadarma, OneCal, WEX invoices) — non-billable internal work
- No Groep Brugge, CAPAC-HVW, Futurwork, Pecco, Reat-Capital, or Recytrans activity detected

**Running totals:**
- Week 22 (Mon 05/25 – Sun 05/31): **1.25h** · Mon: 0.0h + Tue: 1.25h
- Previous Week W21: **6.0h**

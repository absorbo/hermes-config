...
**Saturday 2026-05-30 Timesheet Pre-Fill — Summary**
...
| **Running weekly** | 4.75h (Delvaux 0.75 + Verlinfo 1.0 + Internal 3.0) |

**Entry:** 0.25h Internal/Personal — morning briefing review + email triage. Saturday — no standups, no meetings, no customer activity. Personal writing files (sarajevo-blind) excluded as non-billable.

**⚠️ Maarten's attention needed:**
- OpenRouter API key leak — critical security incident in today's briefing. If you spent time on this, add a separate line.
- Month-end billing cycle — Futurwork invoice reminder pending.

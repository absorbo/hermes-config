...
**📋 Timesheet Pre-Fill — Friday 2026-05-29**

| Metric | Value |
|--------|-------|
| **File changed** | `01 - Daily Notes/2026-05-29.md` |
| **Today's hours** | 2.25h (all `[ESTIMATE]`) |
| **Week 22 running total** | 4.50h |
| **Confirmed (EOD)** | 0 — no EOD feedback received |
| **`[ESTIMATE]` entries** | 5 |
| **`[CONFIRM]` flags** | 4 |

**Entries logged:**
- Delvaux: 0.25h — standup + JIRA update (Fri standup day)
- Internal: 0.25h — email triage (16 emails)
- Internal: 0.25h — ANAF/DorVenture SPV check, Sokin draft review
- Internal: 0.75h — Code in Place (13:00-13:50)
- Internal: 0.75h — Reports block (15:00-15:50)

**⚠️ Items needing attention:**
1. Delvaux standup — [CONFIRM: attended?]
2. Code in Place / Reports block — verify attendance and duration
3. Sokin onboarding draft — [CONFIRM: response submitted?]
4. **Groep Brugge Wed 05/27 meeting still unlogged** — 1.0h estimate. This has been flagged since Thursday. [CONFIRM: add before week closes?]

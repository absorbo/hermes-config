...
**Content Pipeline Health Check — 2026-05-24 (Sunday)**

**🚨 ALERT — Pipeline critically low**

| Metric | Actual | Required | Status |
|--------|--------|----------|--------|
| Schedulable (next 14 days) | 0 | ≥ 4 | ⚠️ **−4** |
| Drafted pipeline (beyond 14 days) | 13 | ≥ 8 | ✅ OK (+5) |
| Days since last post | 30 days | ≤ 7 | ⚠️ **+23 over** |

**Key findings:**

- **0 approved/schedulable items** within the next 14 days. All three approved items (W1-LI-B, W1-FB-B, W2-FB-B) have past dates from April/May 6.
- **0 drafted items** scheduled within 2 weeks. Five W2 drafts exist in Drafts.md but await approval — no publish dates assigned.
- Last actually posted content: **April 24** (30 days ago). Posted log is empty since then.

**The pipeline is healthy behind the wall** — 5 drafts + 8 ideas = 13 items beyond 14 days (exceeds the ≥ 8 minimum). Nothing is missing structurally.

**Recommended actions:**
1. **Urgent:** Maarten should approve 1–2 W2 drafts today or Monday so posts can launch this week.
2. **Urgent:** Assign target dates to approved items for Weeks 3 and 4 scheduling.
3. **Investigate:** Was W1-LI-B, W1-FB-B, W2-FB-B ever published, or is the Posted log stale? The 30-day dry spell needs clarification.

Alert appended to `2026-05-24.md` under `## ⚠️ Content Pipeline Alert`.

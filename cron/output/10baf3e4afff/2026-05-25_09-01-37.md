...
Let me check today's daily note to see if the content pipeline status needs updating.

The health metrics for today (May 25, 2026):

**Schedulable (next 14 days = May 25 – June 8):** 
- Approved.md: 0 future-dated items (W1-LI-B Apr 27, W1-FB-B Apr 29, W2-FB-B May 06 — all past)
- Scheduled.md: 0 future-dated items (W1-LI-B Apr 27, W1-FB-B Apr 29 — all past)
- **Count: 0** (need ≥4)

**Drafted pipeline (beyond 14 days):**
- Drafts.md: 5 unapproved items (W2-LI-A, W2-FB-A, W2-LI-B, W2-FB-B, W2-FB-B-ALT)
- Ideas.md: 15 unconverted items
- **Count: 20** (need ≥8)

**Quality checks:**
- Ideas backlog: 15 — ✅ ≥5
- LinkedIn teach-first: ✅ All 5 drafts are teaching/commercial, not just promo
- Days since last content activity: No posted items since Apr 27 — ~28 days gap

---

This is Monday — the rolling-horizon review day is authoritative per the MOC. The daily note already has a comprehensive pipeline status section from the 04:00 morning briefing that captured all gaps. SCHEDULABLE is critically low (0 vs ≥4) but this is the Monday horizon job day where replenishment work is expected and handled authoritatively. No additional alert needed today.

...
## ⚠️ Content Pipeline Health Alert — 2026-05-27

**STATUS: ALERT TRIGGERED** — One of two health metrics is critically below minimum.
...
| **Drafted Pipeline** (Drafts + Ideas) | **26** | ≥ 8 | ✅ OK |

### What's Wrong

1. **Zero schedulable posts** — None of the 14-day horizon (May 27 – June 10) has any approved/scheduled content. All upcoming items are stuck in unapproved drafts.
2. **33 days without a published post** — Last post was April 24 (W1-LI-A / W1-FB-A). The pipeline has been empty for nearly a month.
3. **Week 2 stale** — 9 drafts (W2-LI-A, W2-FB-A, W2-LI-B, W2-FB-B, W2-FB-B-ALT) have been sitting since May 19 with no approval.
4. **W1 posts never posted** — W1-LI-B and W1-FB-B (scheduled Apr 27/29) still show as "staged" but appear unposted.
5. **Week 3 unapproved** — 4 new drafts added today (W3-LI-A, W3-FB-A, W3-LI-B, W3-FB-B) need target dates and approval.

### Quality Checks

- ✅ LinkedIn posts are teaching-first (all 8 drafts reviewed are educational, not salesy)
- ✅ Ideas backlog is healthy (17 items)
- ❌ **33 days since last publish — critically overdue**

### Recommended Actions (for Maarten)

1. **Approve/discard Week 2 items TODAY** — even late is better than the gap continuing. W2-LI-A (What Good GRC Looks Like) + W2-FB-A (NIS2 Post-Deadline) are strong candidates.
2. **Schedule 2 posts this week** minimum — LinkedIn + Facebook, using existing approved drafts.
3. **Set dates for Week 3 items** after review so next week has coverage.
4. **Do NOT add new ideas** — backlog is abundant. Conversion is the bottleneck, not ideation.

> Full alert written to today's daily note: `01 - Daily Notes/2026-05-27.md` under `## ⚠️ Content Pipeline Alert`.

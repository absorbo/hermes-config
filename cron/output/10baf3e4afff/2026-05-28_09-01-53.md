...
## Content Pipeline Health Report — Thu 2026-05-28

**🔴 CRITICAL — Alert appended to today's daily note.**

| Metric | Current | Minimum | Status |
|--------|---------|---------|--------|
| Schedulable (next 14 days) | **0** | 4 | 🔴 CRITICAL |
| Drafted pipeline (beyond 14 days) | **24** | 8 | 🟢 Healthy |
| Last post | Apr 24 (34 days ago) | ≤7 days | 🔴 STALE |
| Ideas backlog | 15 | 5 | 🟢 Healthy |

**Root cause:** The approval gate is blocked. 9 fully written drafts sit in Drafts.md awaiting review. The Approved queue is stale — all 5 items have past target dates (April 24 – May 6) and were never forwarded. Scheduled.md still references April dates. The pipeline has raw material (24 drafted/idea items) but nothing is flowing through to publication.

**Immediate fix:** Review and approve at least 4 drafts today (Thursday is replenishment day per the weekly rhythm). Schedule 2 posts for next week. Clear the stale Approved/Scheduled queues. Then press publish — 34 days without a post.

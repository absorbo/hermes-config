...
⚠️ **Content Pipeline Health Alert — 2026-06-07 (Sunday)**

**Status: ALERT** — schedulable horizon below minimum, with a critical 44-day publishing gap.

**Health metrics:**
- **Schedulable (next 14 days, → 2026-06-21): 0 / 4** ❌ gap of 4
  - `Approved.md` — 3 items, all past (latest 2026-05-06)
  - `Scheduled.md` — 2 items, both past (latest 2026-04-29)
- **Drafted pipeline (beyond 14 days): 30 / 8** ✅ healthy — 11 drafts + 19 ideas

**Critical signal:**
- **44 days since last post** (last: 2026-04-24, W1-FB-A Facebook / W1-LI-A LinkedIn). Target ≤ 7. Six-week silence is decaying LinkedIn/Facebook audience momentum.

**Action recommended (Maarten drives — monitor only, no edits applied):**
1. **🔺 Approve drafts immediately** — 11 drafts ready in `Drafts.md`. Suggested order: W2 case-style supersession (W2-LI-A IR plan, W2-FB-A green dashboard) → W2 alternates → W3 (W3-LI-A, W3-FB-A, W3-LI-B, W3-FB-B).
2. **🔺 Schedule approved posts for 2026-06-08 → 2026-06-21** (4+ slots, Mon/Wed pattern).
3. **🔺 Publish first pair Monday 2026-06-08** — break the 44-day silence. Don't wait for Thursday rhythm; this is critical.
4. **🔼 Thursday 2026-06-11** — standard Tuesday/Thursday cycle to refill horizon.

**Other quality checks:** LinkedIn drafts teach-first ✅ · Ideas backlog 19 ✅ · Sunday check (not skipped) ✅.

Alert has been appended to `01 - Daily Notes/2026-06-07.md` under `## ⚠️ Content Pipeline Alert` (lines 113–148) with the full breakdown and source-link citations.

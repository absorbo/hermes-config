...
To proceed with the monthly invoice preparation, I'll follow the documented workflow while ensuring all critical constraints and steps are respected.

First, let's verify the invoice day:

```json
{"function":"terminal","command":"date '+%Y-%m-%d'"}
```

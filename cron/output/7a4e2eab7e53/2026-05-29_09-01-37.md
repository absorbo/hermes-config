...
May 2026 has 18 working days. The second-to-last was yesterday, 2026-05-28 (Thu). Today (2026-05-29, Fri) is the **last** working day — not the invoice trigger.

June 2026 has 22 working days (no holidays). The second-to-last working day is **2026-06-29** (Mon), which is when the next invoice preparation will run.

...
## Content Pipeline — Wednesday, Week 3 (May 27)

**Action taken:** Drafted W3-LI-B and W3-FB-B (the second LinkedIn + Facebook posts for this week), appended to `Drafts.md`, and consolidated the full approval queue into today's daily note.

**Theme for Week 3:** Evidence & compliance on paper vs real operational control

---

### 📝 Approval Queue — All Items Requiring Maarten's Decision

#### Week 3 — Current Week (4 items)

| ID | Channel | Theme | Status |
|----|---------|-------|--------|
| **W3-LI-A** | LinkedIn | They Passed the Checklist, Failed the Moment *(case study — compliance on paper vs operational control)* | ✅ Drafted Tue |
| **W3-FB-A** | Facebook | They Checked Every Box, Then the Auditor Asked One Question *(commercial — gap review CTA)* | ✅ Drafted Tue |
| **W3-LI-B** | LinkedIn | The Cost of Evidence Fragmentation *(structured observation — collecting ≠ producing under pressure)* | ✅ Drafted today |
| **W3-FB-B** | Facebook | Your Evidence Is Somewhere. Can You Find It? *(commercial — evidence fragmentation → gap review CTA)* | ✅ Drafted today |

#### Week 2 — Pending Approval (5 items, drafted 2026-05-19)

| ID | Channel | Theme | Status |
|----|---------|-------|--------|
| **W2-LI-A** | LinkedIn | What Good GRC Looks Like | Still unapproved |
| **W2-FB-A** | Facebook | NIS2 Deadline Has Passed — Now What? | Still unapproved |
| **W2-LI-B** | LinkedIn | Admin Failure is Systems Failure | Still unapproved |
| **W2-FB-B** | Facebook | Policy Published, Protection Missing | Approved → needs publishing |
| **W2-FB-B-ALT** | Facebook | The Hidden Cost of Reactive Compliance | Still unapproved |

#### Approved & Staged (3 items from Approved.md)

| ID | Channel | Theme | Status |
|----|---------|-------|--------|
| **W2-FB-B** | Facebook | NIS2 enforcement gap | Approved, needs publishing |
| **W1-LI-B** | LinkedIn | AI in compliance | Staged, needs publishing |
| **W1-FB-B** | Facebook | AI commercial | Staged, needs publishing |
...
| # | Action |
|---|--------|
| 1 | **Approve/revise/discard Week 3 LI-B & FB-B** (the two new drafts above) |
| 2 | **Clear the Week 2 backlog** — approve, revise, or discard the 4 unapproved W2 items |
| 3 | **Press the button** on approved-but-unpublished items (W2-FB-B, W1-LI-B, W1-FB-B) |

See the full texts in `60 - Content-Pipeline/Drafts.md` under `## Week 3 Drafts`. The complete approval queue with all draft links is in today's daily note: `01 - Daily Notes/2026-05-27.md`.

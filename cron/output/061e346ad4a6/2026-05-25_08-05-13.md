...
Content Pipeline status report complete. Here's the summary:

## 🚨 Pipeline Health Alert — CRITICAL on Week 2

**This is not a healthy pipeline right now.** Everything in "drafted" and "approved" is past-dated.

| Category | Count | Required | Status |
|----------|-------|----------|--------|
| Schedulable (next 2 weeks) | 0 | ≥4 | 🔴 **CRITICAL** |
| Drafted (W3+) | 0 | ≥8 | ⚠️ **Below minimum** |
| Ideas | 15 | ≥5 | ✅ Healthy |

### Key Findings

1. **Week 2 (this week) has no posted/scheduled content.** The 4 drafts (W2-LI-A, W2-FB-A, W2-LI-B, W2-FB-B) are all past-dated (~May 5). One item (W2-FB-B) reached "Approved" but was never Scheduled or Posted.

2. **Weeks 3+ are completely empty.** No drafts exist for the coming weeks. Ideas backlog (15 items) has never been spun into drafts.

3. **Week 1 was never fully completed** — W1-LI-B (LinkedIn: AI in compliance, target 2026-04-27) is Approved but remains unstaged/unposted.

### This Week's Theme

**Bucket 7: Case-style scenarios or lessons** — a real-world case of a company that passed compliance checklists but failed under actual scrutiny. LinkedIn angle: teach through narrative. Facebook angle: commercial hook around the gap between "checked boxes" and real readiness.

### Recommendations for Maarten

1. **Today:** Pick 2 of the 4 existing W2 drafts (content is still fresh) and schedule them for this week
2. **Today:** Also post W1-LI-B (AI in compliance) — it was approved but never scheduled
3. **Tuesday:** Draft 6 posts covering W3-W4 (convert 6 of the 15 ideas) to rebuild the horizon to 4+ weeks
4. **Thursday:** Refine and schedule approved posts, continue drafting

### Files Updated

- `01 - Daily Notes/2026-05-25.md` — appended Content Pipeline Status section
- `60 - Content-Pipeline/00-Content-Pipeline-Master.md` — updated status table to Week 1–4 with actual states

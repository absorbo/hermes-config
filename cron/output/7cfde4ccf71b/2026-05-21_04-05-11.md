...
**Daily note created:** `01 - Daily Notes/2026-05-21.md`
...
|--------|--------|--------|
| Gmail | 0 | Clean inbox ✅ |
| M365 | 14 (of 30) | Triaged |

**Triage breakdown:**
- 🔺 **Action Required: 3 tasks** — Productive time tracking (Xcellerate, May 20 gap), Verlinfo/Groep Brugge Gwijde meeting prep (4-point proposals due tomorrow), confirm Friday May 22 prep call (Monday blocked by Pentecost)
- ⏫ **Important: 0**
- 🔼 **FYI: 4** — bol invoices/shipments, Classictravel.com welcome
- 🔽 **Ignored: 8** — marketing, social, spam

**🔺 Key item flagged:** Koen Vandenabeele (Verlinfo/Verla) thread about meeting with Gwijde on Tuesday May 26. Koen proposed prep call **Friday May 22, 11:00–12:00**. Maarten needs to send 4-point proposals today (Thursday). Monday May 25 is Pinkstermaandag — Teams reschedule needed. Draft reply included in note. Cross-referenced against `verla reaudit` carryover from May 17 & 19.

...
| Item | Result |
|------|--------|
| Daily note | ✅ Created `01 - Daily Notes/2026-05-22.md` |
| Gmail | 0 unread (no action needed) |
| M365 | 12 unread → triaged |
| 🔺 Action | 1 (Seats and Sofas pickup by Sat May 23) |
| ⏫ Important | 2 (De Watergroep invoices for Minotaur Solutions BV) |
| 🔼 FYI | 3 (PayPal, LiberNovo, Amazon orders) |
| 🔽 Ignored | 6 (marketing/shipping/promo) |
| Tasks created | 3 (`#task` tagged with priority + due dates) |
| Errors | None |

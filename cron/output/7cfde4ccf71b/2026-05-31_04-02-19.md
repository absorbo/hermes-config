...
**Morning Briefing complete — 2026-05-31 (Sunday).**

| What | Result |
|------|--------|
| Yesterday's EOD feedback | None — skipped follow-up section |
| Daily note | Created `01 - Daily Notes/2026-05-31.md` |
| Gmail unread | 0 |
| M365 unread | 5 |
| 🔺 Action Required | 0 |
| ⏫ Important | 0 |
| 🔼 FYI | 1 (Belcar lease invoice) |
| 🔽 Ignored | 4 (Synthesys, Billit/Peppol, Leadsparker, Plex) |
| Drafts created | 0 (no actionable emails) |
| Errors | None |

...
| Metric | Count |
|--------|-------|
| Daily note | Created (`01 - Daily Notes/2026-05-20.md`) |
| Gmail unread (trusecure.co) | 1 |
| M365 unread (minotaur-solutions.com) | 10 |
| 🔺 Action Required | 2 |
| ⏫ Important | 1 |
| 🔼 FYI | 5 |
| 🔽 Ignored | 3 |
| Emails read in full | 3 (Watergroep, Sunweb, GitHub) |
| Draft replies written | 0 (all action-based, not reply-based) |
| Vault cross-references found | 0 (personal/financial emails, no customer/project overlap) |

**⚠️ Attention needed:**
- **Sunweb payment deadline is May 24** — 4 days away, €4,009.71 still unpaid
- **De Watergroep meter reading** — deadline May 29, needs physical meter access at Nederweg 11, Izegem

**No errors or blockers.** Both Gmail and M365 services responded normally.
